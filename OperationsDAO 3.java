...
public class OperationsDAO {
	...
	public void listAllFiles(String path) {
		...
		if(!dir.exists())
			throw new IllegalArgumentException("The given path is a file. A directory is excepted.");
		...
		if(files != null && files.length > 0) {
			...
			System.out.println("\nTotal Number of files:" + filesList.size());
				...
				System.out.println("Directtory is Empty");
...
if(createFile) {
	...
	System.out.println("\nFile Succesfully Created: " + newFile.getAbsolutePath());
	}else if(!createFile) {
